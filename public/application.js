...
var config = {
  apiOrigins: {
    ...
    production: 'https://square-toast.herokuapp.com'
  }
};
...
var showOrdersTemplate = __webpack_require__(18);
var store = __webpack_require__(2);
var sharedUi = __webpack_require__(5);

var showOrderNew = function showOrderNew() {
  sharedUi.hideAlert();
...
var showOrderList = function showOrderList() {
  sharedUi.hideAlert();
  // show appropriate div / hide all others
...
var showOrderGet = function showOrderGet() {
  sharedUi.hideAlert();
  // show appropriate div / hide all others
  $('#order-create-div').addClass('hidden');
  $('#order-list-div').addClass('hidden');
...
var showOrderPos = function showOrderPos() {
  sharedUi.hideAlert();
  // show appropriate div / hide all others
  $('#order-create-div').addClass('hidden');
  $('#order-list-div').addClass('hidden');
...
var posBtnPress = function posBtnPress(desc, price) {
...
var posButtonClear = function posButtonClear() {
  $('#order-create-pos-description').val('');
  $('#order-create-pos-price').val('');
};

var orderCreateSuccess = function orderCreateSuccess(data) {
...
var orderCreateFailure = function orderCreateFailure() {
  sharedUi.showAlert('alert-danger', 'Error creating order');
};

var orderCreatePosSuccess = function orderCreatePosSuccess(data) {
  sharedUi.showAlert('alert-success', 'Order # ' + data.order.id + ' created!');
  // clear user entered values from input fields ready for next entry
  $('#order-create-pos-description').val('');
  $('#order-create-pos-price').val('');
...
var orderCreatePosFailure = function orderCreatePosFailure() {
  sharedUi.showAlert('alert-danger', 'Error creating order');
};

var orderListSuccess = function orderListSuccess(data) {
  sharedUi.showAlert('alert-info', 'Order list generated successfully');
  data.orders.sort(function (a, b) {
    return a.id - b.id;
  });
  var showOrdersHtml = showOrdersTemplate({ orders: data.orders });
  $('#order-list-content').append(showOrdersHtml);
};

var orderListClear = function orderListClear() {
  sharedUi.hideAlert();
  $('#order-list-content').empty();
};

var orderListFailure = function orderListFailure() {
  sharedUi.showAlert('alert-danger', 'Error getting order list');
};

var orderGetSuccess = function orderGetSuccess(data) {
...
var orderGetFailure = function orderGetFailure() {
...
var orderUpdateSuccess = function orderUpdateSuccess(data) {
...
var orderUpdateFailure = function orderUpdateFailure() {
  sharedUi.showAlert('alert-danger', 'Error updating order');
};

var orderDestroySuccess = function orderDestroySuccess() {
...
var orderDestroyFailure = function orderDestroyFailure() {
  var orderId = $('#order-edit-input-id').val();
...
module.exports = {
  showOrderNew: showOrderNew,
  showOrderList: showOrderList,
  showOrderGet: showOrderGet,
  showOrderPos: showOrderPos,
  posBtnPress: posBtnPress,
  posButtonClear: posButtonClear,
  orderCreateSuccess: orderCreateSuccess,
  orderCreateFailure: orderCreateFailure,
  orderCreatePosSuccess: orderCreatePosSuccess,
  orderCreatePosFailure: orderCreatePosFailure,
  orderListSuccess: orderListSuccess,
  orderListClear: orderListClear,
  orderListFailure: orderListFailure,
  orderGetSuccess: orderGetSuccess,
  orderGetFailure: orderGetFailure,
  orderUpdateSuccess: orderUpdateSuccess,
  orderUpdateFailure: orderUpdateFailure,
  orderDestroySuccess: orderDestroySuccess,
  orderDestroyFailure: orderDestroyFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onNewUser = function onNewUser() {
  event.preventDefault();
  sharedUi.hideAlert();
...
var onNewUserCancel = function onNewUserCancel() {
  event.preventDefault();
  sharedUi.hideAlert();
...
var onChangePasswordBtn = function onChangePasswordBtn() {
  event.preventDefault();
  sharedUi.hideAlert();
...
var onChangePasswordCancel = function onChangePasswordCancel() {
  event.preventDefault();
...
var store = __webpack_require__(2);
var sharedUi = __webpack_require__(5);
var orderUi = __webpack_require__(8);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "       <tr class='clickable-row' style=\"cursor: pointer\" data-id=\""
  ...
  return "<!-- <script id=\"order-list-template\" type=\"text/x-handlebars-template\"> -->\n  <table class=\"table table-striped table-bordered table-condensed table-hover\">\n     <thead>\n       <tr>\n           <th>Order</th>\n           <th>Date</th>\n           <th>Details</th>\n           <th>Status</th>\n           <th class=\"text-right\">Price</th>\n       </tr>\n     </thead>\n     <tbody>\n"
...
var onBtnOrderNew = function onBtnOrderNew() {
  ui.showOrderNew();
};

var onBtnOrderList = function onBtnOrderList() {
  ui.showOrderList();
  onOrderList();
};

var onBtnOrderGet = function onBtnOrderGet() {
  ui.showOrderGet();
};

var onBtnOrderPos = function onBtnOrderPos() {
  ui.showOrderPos();
};

var onPosButtonPress = function onPosButtonPress(event) {
  var desc = event.target.getAttribute('data-description');
  var price = event.target.getAttribute('data-price');
  ui.posBtnPress(desc, price);
};

var onPosButtonClear = function onPosButtonClear() {
  ui.posButtonClear();
};

var onBtnOrderSearch = function onBtnOrderSearch(event) {
  event.preventDefault();
  var orderId = $('#order-edit-input-id').val();
  api.orderGet(orderId).then(ui.orderGetSuccess).catch(ui.orderGetFailure);
};

var onOrderCreate = function onOrderCreate(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.orderCreate(data).then(ui.orderCreateSuccess).catch(ui.orderCreateFailure);
};

var onOrderCreatePos = function onOrderCreatePos(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.orderCreate(data).then(ui.orderCreatePosSuccess).catch(ui.orderCreatePosFailure);
};

var onOrderList = function onOrderList(event) {
  ui.orderListClear();
  api.orderList().then(ui.orderListSuccess).then(function () {
    $('.clickable-row').on('click', onOrderListClick);
  }).catch(ui.orderListFailure);
};

var onOrderListClick = function onOrderListClick() {
  var orderId = event.target.parentNode.getAttribute('data-id');
  ui.showOrderGet();
  $('#order-edit-input-id').val(orderId);
  api.orderGet(orderId).then(ui.orderGetSuccess).catch(ui.orderGetFailure);
};

var onOrderUpdate = function onOrderUpdate(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.orderUpdate(data).then(ui.orderUpdateSuccess).catch(ui.orderUpdateFailure);
};

var onOrderStatusUpdate = function onOrderStatusUpdate(event) {
...
var onOrderDestroy = function onOrderDestroy(event) {
  api.orderDestroy(store.order.id).then(ui.orderDestroySuccess).catch(ui.orderDestroyFailure);
};
...
var orderCreate = function orderCreate(data) {
  return $.ajax({
...
var orderGet = function orderGet(orderId) {
  return $.ajax({
...
var orderDestroy = function orderDestroy(orderId) {
  return $.ajax({
    url: config.apiOrigin + '/orders/' + orderId,
    method: 'DELETE',
    headers: {
